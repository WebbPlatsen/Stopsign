<?php
/**
 * Default (plain table) output template for Stopsign (widget)
 *
 * @package    Stopsign
 ...
 *
 * 1. /wp-content/themes/<theme>/stopsign/templates/stopsign_default_widget.php
 *    (e.g. /wp-content/themes/twentytwenty/stopsign/templates/stopsign_default_widget.php)
 *
 * 2. /wp-content/plugins/stopsign/public/templates/stopsign_default_widget.php
 *
 ...
 *
 * The entire table is enclosed in a DIV with CSS class "stopsign-stop-widget"
 *
 *
 * stopsign_default_widget.php
