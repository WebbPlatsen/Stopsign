<?php
/**
 * Grouped (table) output template for Stopsign
 *
 * @package    Stopsign
 ...
 *
 * 1. /wp-content/themes/<theme>/stopsign/templates/stopsign_grouped.php
 *    (e.g. /wp-content/themes/twentytwenty/stopsign/templates/stopsign_grouped.php)
 *
 * 2. /wp-content/plugins/stopsign/public/templates/stopsign_grouped.php
 *
 ...
 *
 * The entire output is enclosed in a div with class "stopsign-grouped-commute-stop"
 *
 *
 * stopsign_default_grouped.php
...
<div class="stopsign-grouped-header">
...
<div class="stopsign-grouped-time">{stopsign_group_time}</div>
GROUPED_ROW;
?>